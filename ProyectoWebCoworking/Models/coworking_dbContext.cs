...
public partial class coworking_dbContext : DbContext
{
    ...
    // Sin OnConfiguring a propósito: la cadena de conexión no vive en el código, se inyecta
    // vía AddDbContext en Program.cs desde configuración (user secrets en desarrollo,
    // variables de entorno en producción). Ver README § Configuración.
